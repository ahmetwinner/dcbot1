...
if (!['pc','xbl','psn'].includes(args[0])) message.channel.send('**Lütfen Platform Seçin**: `a!fortnite pc | xbl | psn kullanıcıadı` **Örnek**: `a!fortnite pc Dark` ');

if (!args[1]) return message.channel.send('**Lütfen Kullanıcı İsmi Girin**: `a!fortnite pc | xbl | psn kullanıcıadı` **Örnek**: `a!fortnite pc Dark` ');
